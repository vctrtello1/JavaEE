<%@page contentType="text/html" pageEncoding="UTF-8" import="com.victortello.models.*" %>
    <% Carro carro=(Carro) session.getAttribute("carro"); %>
        ...
        <body>
            ...
            <% if(carro==null || carro.getItems().isEmpty()){%>
                ...
                <%} else { %>
                    <form name="formCarro" action="<%=request.getContextPath()%>/actualizarCarro" method="post">
                        <table>
                            <tr>
                                <th>id</th>
                                <th>nombre</th>
                            ...
                            <%for(ItemCarro item: carro.getItems()){%>
                                <tr>
                                    ...
                                    <td><input type="checkbox" value="<%=item.getProducto().getId()%>"
